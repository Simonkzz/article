...
####################################################################################################
####################################################################################################
FILEPATHLF = './FinalData/sub/RRColumns.xlsx'
dataLR = pd.read_excel(FILEPATHLF)
StrideLRList = pd.DataFrame(dataLR)
StrideLRList[StrideLRList.RRP > 0.8].to_excel("./FinalData/sub/sub/RRRRRRRColumns.xlsx", index=False)
data1 = pd.read_excel("./FinalData/sub/sub/RRRRRRRColumns.xlsx")
...
# plt.xticks(LastNumber, ticks=100, rotation=45, fontsize=10)
